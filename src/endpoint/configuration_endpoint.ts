...
import { ConfigurationRequestHandler } from 'https://deno.land/x/authlete_deno_oak@v1.0.3/mod.ts';
...
export class ConfigurationEndpoint extends BaseEndpoint
{
    ...
    {
        await new ConfigurationRequestHandler(this.api).handle(ctx, true);
    }
}